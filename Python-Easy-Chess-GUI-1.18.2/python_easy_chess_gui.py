...
class EasyChessGui:
    ...
    def __init__(self, theme, engine_config_file, user_config_file,
        ...
        self.sq_dark_color = '#9f75d7'

        # Move highlight, for purple board
    ...
    def create_bank(self, is_user_white=True):
        """
        ...
        """
        file_char_name = 'wxyz'
        self.psg_bank = copy.deepcopy(initial_bank)
        ...
        for i in range(start_rank, end_rank, step_rank):
    ...
    def build_main_layout(self, is_user_white=True):
        ...
        # Define bank
        bank_layout = self.create_bank(is_user_white)
        ...
        bank_tab = [[sg.Column(bank_layout)]]
    ...
    def main_loop(self):
        ...
        while True:
            ...
            # Mode: Neutral, Change board to purple
            if button == 'Purple::board_color_k':
                self.sq_light_color = '#ffffff'
                self.sq_dark_color = '#9f75d7'
                self.move_sq_light_color = '#d2e4ba'
                self.move_sq_dark_color = '#91bc9c'
